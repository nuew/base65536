...
/// failing on line breaks (such as those generated by [`encode`] and
/// [`encode_buf`] when wrapping is enabled), as to match behaviour with the
/// [original implementation]. To prevent this, use with the `ignore_garbage`
/// option.
///
